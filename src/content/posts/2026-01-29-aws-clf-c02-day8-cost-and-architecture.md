...
category: "study"
subcategory: "aws"
description: "AWS Certified Cloud Practitioner(CLF-C02) 스터디 8회차 기록. EC2 구매 옵션, Savings Plans, Cost Explorer와 Budgets, Well-Architected Framework와 CAF를 시험 관점과 실무 관점에서 자세히 정리했다."
...
reference 폴더 기준으로 8회차와 직접 연결되는 자료 파일은 현재 아래 1개가 확인된다. 복습용으로 바로 내려받을 수 있게 정적 경로로 옮겨두었다.

- [ACF.png](/downloads/aws-clf-c02/2026-01-29/ACF.png)
  CloudFront/엣지 계층 관련 보조 자료로 보이는 이미지 파일.

이번 회차는 발표자 일정표에 비해 reference 폴더에 남아 있는 자료가 적었다. 그래서 글 본문은 8회차 발표 범위 전체를 기준으로 자세히 정리했고, 다운로드 섹션은 실제로 확인 가능한 파일만 연결했다.
