...
author: "Evan Yoon"
category: "project"
description: "신규 입사자가 혼자서도 온보딩을 완료할 수 있도록 FAQ 검색, 체크리스트, AI 챗봇을 하나의 모바일 앱으로 만든 프로젝트. React Native + Node.js + GPT-4o-mini 7시간 개발기."
tags:
  - react-native
  - expo
  - openai
...
<video controls preload="metadata" style="display:block; width:100%; max-width:760px; margin:1rem auto;">
  <source src="/files/onboarding-assistant-demo.mp4" type="video/mp4" />
  브라우저가 동영상을 지원하지 않으면 <a href="/files/onboarding-assistant-demo.mp4">여기서 영상을 열 수 있다</a>.
</video>
