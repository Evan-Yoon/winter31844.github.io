...
강사님도 그걸 전제로 설명을 시작했다. 모두가 같은 길로 가는 게 아니라는 뜻이었다. 누군가는 모델링을 깊게 파야 하고, 누군가는 도메인 이해를 살려 제품 쪽으로 가야 하고, 누군가는 기술과 고객 사이를 잇는 역할이 더 잘 맞을 수 있다. 이 전제가 깔리니까 강의가 훨씬 덜 뜬구름 같았다.
