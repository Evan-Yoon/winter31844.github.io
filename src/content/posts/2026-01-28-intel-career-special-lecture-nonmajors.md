...
강의에서 가장 오래 남은 문장은 이 부분이었다. `Domain vs Modeling`이 아니라 `Domain and Modeling`이라고 적어 둔 대목이었다. 예전에는 AI 직무라고 하면 최신 모델 구조를 얼마나 잘 아는지, 논문을 얼마나 빠르게 따라가는지가 핵심처럼 느껴졌다. 그런데 여기서는 이제 실무에서 더 중요해지는 건 "어떤 모델이 더 좋으냐"만 아는 사람이 아니라, 특정 산업의 문제를 이해하고 그 모델을 실제 서비스에 붙일 수 있는 사람이라고 짚었다.
...
<img src="/images/posts/intel-career-special-lecture-nonmajors/slide-domain-modeling.png" alt="도메인 이해와 모델링의 관계" style="display:block; width:100%; max-width:700px; margin:1rem auto;" />
...
후반부에서 가장 현실적으로 느껴진 건 외국계 SW/IT 기업의 한국 지사를 `세일즈 오피스`라는 관점으로 설명한 부분이었다. "본사가 만들고 지사가 판다"는 한 줄이 구조를 이해하는 데 꽤 강했다.
...
<img src="/images/posts/intel-career-special-lecture-nonmajors/slide-b2b-cycle.png" alt="B2B 판매 사이클과 담당 역할" style="display:block; width:100%; max-width:700px; margin:1rem auto;" />
...
<img src="/images/posts/intel-career-special-lecture-nonmajors/slide-sales-office-roles.png" alt="세일즈 오피스 주요 직군 비교" style="display:block; width:100%; max-width:700px; margin:1rem auto;" />
...
<img src="/images/posts/intel-career-special-lecture-nonmajors/slide-hiring-process.png" alt="기술 기반 직군의 채용 프로세스" style="display:block; width:100%; max-width:700px; margin:1rem auto;" />
