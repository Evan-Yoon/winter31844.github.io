...
## 1. 예외 처리의 출발점: 프로그램은 언제든 실패할 수 있다 <!-- short: 1. 예외 처리의 출발점 -->
...
## 4. 사용자 정의 예외: 비즈니스 규칙 위반도 예외로 표현할 수 있다 <!-- short: 4. 사용자 정의 예외 -->
...
## 5. 일반 API와 래퍼 클래스: 값과 타입을 객체처럼 다루기 <!-- short: 5. 일반 API와 래퍼 클래스 -->
...
## 10. 제네릭 메서드: 클래스 전체가 아니라 메서드만 일반화하기 <!-- short: 10. 제네릭 메서드 -->
...
## 11. 제한된 타입 매개변수: 아무 타입이나 받지 않게 만들기 <!-- short: 11. 제한된 타입 매개변수 -->
