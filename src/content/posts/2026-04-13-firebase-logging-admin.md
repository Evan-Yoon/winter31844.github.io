...
사고 대응의 핵심은 "언제, 누가, 무엇을"을 나중에 재구성할 수 있는 기록이다. Firebase 규칙이 막아줬다고 해서 기록이 필요 없는 건 아니다. 규칙이 놓친 게 있을 수도 있고, 규칙이 바뀐 사이에 뭔가 들어올 수도 있다.

Cloud Function 한 줄 추가로 이 기반을 갖출 수 있다는 게 생각보다 간단했다.
