...
description: Walkmate 프로젝트 전체를 정리한 회고. 초기 구상, 관리자 화면, YOLO11 한계, YOLO26 전환, 출력 형식
  오류로 인한 오탐, 위험도/음성 안내 로직까지 한 글로 묶음.
...
- [결과보고서_3팀(공부많이된다)_260225.pptx](/files/walkmate-final-report-team3.pptx)
