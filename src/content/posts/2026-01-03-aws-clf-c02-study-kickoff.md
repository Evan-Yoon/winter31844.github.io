...
특히 좋았던 점은 처음부터 "언제까지, 어떤 방식으로, 얼마나 할지"가 분명했다는 것이다. 자격증 공부는 범위를 넓게 잡으면 금방 흐트러지기 쉬운데, 이번 스터디는 애초에 시험 일정까지 염두에 둔 단기 집중형이었다.
...
스터디는 회차별로 발표자를 정해서 돌아가며 진행하는 구조였다. 발표자 배정표를 보니 그냥 강의를 같이 듣는 수준이 아니라, 각자 소주제를 맡아서 직접 정리하고 설명해야 했다.
...
이 방식이 좋았던 이유는 분명했다. 듣기만 하면 이해한 것 같다가도 금방 흐려지는데, 직접 설명해야 하면 용어 정의와 개념 차이를 확실히 정리하게 된다. Cloud Practitioner는 서비스 이름이 많고 비슷한 개념이 자주 엮여 나와서, 이렇게 발표를 맡아 정리하는 방식이 특히 잘 맞았다.
