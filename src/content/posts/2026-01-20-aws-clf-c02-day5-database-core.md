...
description:
  AWS Certified Cloud Practitioner(CLF-C02) 스터디 5회차 기록. RDS와 Aurora, DynamoDB,
  ElastiCache, Redshift의 차이와 각 서비스의 목적
...
## RDS에서 자주 헷갈리는 것: Multi-AZ vs Read Replica <!-- short: RDS에서 자주 헷갈리는 것 -->
...
- [05*Database 심화*지현.html](/downloads/aws-clf-c02/2026-01-20/05_Database%20%EC%8B%AC%ED%99%94_%EC%A7%80%ED%98%84.html)
  DynamoDB, ElastiCache, Redshift 중심의 발표 자료.

- [05*Database 심화\_add*지현.pptx](/downloads/aws-clf-c02/2026-01-20/05_Database%20%EC%8B%AC%ED%99%94_add_%EC%A7%80%ED%98%84.pptx)
  5회차 보강 자료.
