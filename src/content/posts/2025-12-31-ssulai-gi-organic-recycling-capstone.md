...
description: "2025년 12월 29일부터 31일까지 진행한 폐기물 자동 분류 미니 프로젝트 기록. 문제 정의, 5W1H, 데이터 탐색, CNN 모델 비교, 전처리와 증강, optimizer와 learning rate scheduler 조정, YOLO 기반 실시간 분류 가능성까지 정리했다."
