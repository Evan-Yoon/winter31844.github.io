...
## 1. 다형성 복습: 호출부는 단순하게, 실제 동작은 다양하게 <!-- short: 1. 다형성 복습 -->
...
## 3. 추상 클래스: 공통 부분은 주고, 핵심 동작은 자식에게 맡긴다 <!-- short: 3. 추상 클래스 -->
...
## 6. 인터페이스: 역할만 정의하고 구현은 각 클래스에 맡긴다 <!-- short: 6. 인터페이스 -->
...
## 8. `default` 메서드: 인터페이스도 기본 동작을 가질 수 있다 <!-- short: 8. `default` 메서드 -->
